...
ffmpeg.setFfmpegPath('C:\\Users\\Administrator\\Downloads\\ffmpeg-n5.0-latest-win64-lgpl-5.0\\bin\\ffmpeg');
ffmpeg.setFfprobePath('C:\\Users\\Administrator\\Downloads\\ffmpeg-n5.0-latest-win64-lgpl-5.0\\bin\\ffprobe');
var vname = '1';
var input = './input';
var output = './output';
var middle = './middle';
...
//     });
    ...
    .then(() => {
        return new Promise((resolve) => {
            ffmpeg(path.join(__dirname, input, '1.mp4'))
                .input(path.join(__dirname, input, '1.jpg'))
                .inputOptions(
...
// [https://github.com/Nana-Cti/fluent-ffmpeg-watermark](https://github.com/Nana-Cti/fluent-ffmpeg-watermark)
